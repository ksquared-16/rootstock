...
// File erc-payable-token/contracts/token/ERC1363/IERC1363.sol@v4.9.7
...
// File erc-payable-token/contracts/token/ERC1363/IERC1363Receiver.sol@v4.9.7
...
// File hardhat/console.sol@v2.22.14
...
// File contracts/OneMilNftPixels.sol
...
contract OneMilNftPixels is ERC721, Ownable, IERC1363Receiver {
    ...
    function _transferReceived(
        ...
        require(
            amount == callAmount,
            "Fake amount exceeds actual amount transferred"
        );
        require(
            callAmount >= pixelPrice,
            "Stop fooling me! Are you going to pay?"
        );
